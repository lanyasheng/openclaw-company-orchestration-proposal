...
> **角色**: ✅ **验证状态清单** — 明确"哪些已证实、哪些未证实、为什么选这个方向"
>
> **何时阅读**:
> - 质疑"这个方向有证据吗"
> - 准备引入新依赖/框架前检查验证状态
> - 理解为什么排除某些方案 (Temporal-first / LangGraph-first 等)
>
> **与 CURRENT_TRUTH 关系**: `CURRENT_TRUTH.md` 讲"今天实际如何工作"；本文档讲"这个方向有多少证据支持"
>
> **边界说明**: 本文档只记录验证结论和证据位置，不包含实现细节
>
> **证据位置**: 验证证据分散在 `docs/validation/`、`tests/`、runtime commits 中；本文档是索引
