...
> **角色**: 📋 **技术债务与 Backlog** — 跟踪"已知优化点、待清偿债务、未来计划"
>
> **何时阅读**:
> - 规划下一轮重构/清理
> - 理解为什么某些代码保留但标记 deprecated
> - 评估新功能是否会引入新债务
>
> **与 CURRENT_TRUTH 关系**: `CURRENT_TRUTH.md` 讲"今天实际如何工作"；本文档讲"哪些地方需要改进"
>
> **边界说明**: 本文档是活文档，随迭代更新；已完成的批次会标记 ✅ 并保留记录
>
